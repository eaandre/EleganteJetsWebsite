...
const ServicesGrid = dynamic(() =>
  import("@/components/service.grid").then((mod) => mod.ServicesGrid)
);
...
export const metadata: Metadata = {
  ...
  description:
    "Experience unparalleled luxury in private aviation with Elegante Jets & Concierge. Tailored charter services, premium concierge, and bespoke travel solutions.",
  keywords:
    "private jets, luxury travel, concierge services, charter flights, VIP transportation",
};
    ...
    <div className="bg-background text-foreground">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            <Card className="w-64 text-center">
              ...
              <CardContent>
                <p className="text-foreground">
                  Bespoke experiences customized to your needs.
                </p>
              </CardContent>
            </Card>
            <Card className="w-64 text-center">
              ...
              <CardContent>
                <p className="text-foreground">
                  Travel in absolute elegance with world-class amenities.
                </p>
              </CardContent>
            </Card>
            <Card className="w-64 text-center">
              ...
              <CardContent>
                <p className="text-foreground">
                  We uphold the highest industry standards in safety and
                  reliability.
                </p>
              </CardContent>
            </Card>
            <Card className="w-64 text-center">
              ...
              <CardContent>
                <p className="text-foreground">
                  Book with ease using our tech-driven platform.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-background text-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-8 text-lg text-foreground">
            Contact us to book your journey or learn more about our premium
            services.
          </p>
          <div className="mb-8">
            <p>
