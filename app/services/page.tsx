      ...
      <section className="py-16 bg-muted text-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 text-foreground">
            Experience unparalleled luxury and convenience with our range of
            exclusive private aviation services.
          </p>
        </div>
      </section>
      <ServicesGrid />
      ...
      <section className="py-16 bg-background text-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-8 text-lg text-foreground">
            Contact us today to discuss your travel needs and experience the
